...
public class MyAdapter extends RecyclerView.Adapter<MyViewHolder>{
    ...
    //to pass and assign info into recyler view
    @NonNull
    @Override
...
class MyViewHolder extends RecyclerView.ViewHolder{
    ...
    //to take records of the input
    ImageView recImage;
    TextView recTitle, recAuthor, recDesc, recLang;
    CardView recCard;

    //assign each recycler to its respective item
